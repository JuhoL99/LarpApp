...
public class GameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        p.playerAddedRelations[1].AddNoteToUser("i am user 2");
        /*
        ...
        string jsonNotes = "{\"allNotesList\":[{\"noteList\":[\"testnote 1\",\"fhsjdghjsghsj<gdhfhjdhkjfdkhjdhdfjzhjd\"]},{\"noteList\":[]},{\"noteList\":[]},{\"noteList\":[]},{\"noteList\":[]},{\"noteList\":[]},{\"noteList\":[]},{\"noteList\":[]},{\"noteList\":[]},{\"noteList\":[]}]}";
        Debug.Log($"loaded string: {l}");
        p.LoadUserNotesFromString(jsonNotes);
        Debug.Log($"loaded jsonstring: {jsonNotes}");
        Debug.Log(p.GetUserNotesString());
        p.playerAddedRelations[0].AddNoteToUser("testnote 1");
        p.playerAddedRelations[0].AddNoteToUser("fhsjdghjsghsj<gdhfhjdhkjfdkhjdhdfjzhjd");
